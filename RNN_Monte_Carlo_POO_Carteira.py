...
if __name__ == "__main__":
    ...
    #ticker = ['EMBR3.SA', 'CCRO3.SA', 'UGPA3.SA', 'VIVA3.SA']
    ...
    # Executando o objeto ModeloFinanceiro - RNN - LSTM 
    ModeloFinanceiro.executar(ticker, data_inicial, data_final, tamanho_sequencia, num_simulacoes, num_dias)
