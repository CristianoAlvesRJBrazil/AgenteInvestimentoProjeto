...
if __name__ == "__main__":
    ...
    import chamar_classe_carteira_aleatoria
    ...
    Ativos = chamar_classe_carteira_aleatoria.main(lista_ativos, inicio_dados, final_dados, valor_desejado)
    
    # Chamar_classe_carteira_aleatoria.main()
    ticker = Ativos
    num_simulacoes = 1000
    num_dias = 60
