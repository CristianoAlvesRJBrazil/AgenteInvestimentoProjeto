...
if __name__ == "__main__":
    ...
    #tickers = ['VIVT3.SA', 'ECOR3.SA', 'POMO4.SA', 'MULT3.SA']
    ...
    for i in range(5):
        ...
        precos_medios_simulados.append(np.mean(precos_simulados_rnn[:, -1]))
    ...
    print(f"Média das probabilidades: {round(np.mean(todas_simulacoes), 4)}")
    print(f"Média dos preços futuros simulados: {np.mean(precos_medios_simulados)}")
